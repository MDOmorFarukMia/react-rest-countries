    ...
    <section className="py-6 dark:bg-gray-800 dark:text-gray-50">
      <div className="container mx-auto p-4 sm:p-10">
        <div className="mb-16 space-y-4 text-center">
          ...
          <div>
            <button className="px-4 py-1 font-semibold border rounded-l-lg bg-violet-400 border-violet-400 dark:text-gray-900">
              Monthly
            </button>
        ...
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:max-w-full lg:gap-2 xl:gap-6 lg:grid-cols-3">
          ...
          <div className="relative flex flex-col items-center p-8 border-2 rounded-md border-violet-400 bg-gray-800 text-white">
            <span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-violet-400 text-white">
              Professional
            </span>
